...
const Showcase = () => {
    ...
    React.useEffect(()=>{
        const fetchAllPosts = async () => {
            ...
            try{
                const response = await fetch('https://imaginai-server.onrender.com/api/v1/post/allposts',{
                    method: 'GET',
                    headers: {
    ...
    return(
        <section className="max-w-7xl mx-auto sm:px-20 px-6 text-slate font-poppins mb-10">
            ...
            <div>
                ...
                <p  className="mt-2 text-slate text-[16px] max-w=[500px] font-poppins">Browse through a collection of imaginative and visually stunning images generated by ImaginAI</p>
            </div>
            <div className="mt-8">
                <FormField 
